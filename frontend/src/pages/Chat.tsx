    ...
    >
      <Box
        ...
        >
          ...
          >
            {auth?.user?.name?.[0]} {/* First letter of first name */}
            {auth?.user?.name?.split(" ")[1]?.[0] || ""} {/* First letter of last name, if exists */}
          </Avatar>
      ...
      <Box sx={{ display: "flex", flex: { md: 0.8, xs: 1, sm: 1 }, flexDirection: "column", px: 3, }}>
        ...
        <div style={{
          ...
          />
          <IconButton onClick={handleSubmit} sx={{ ml: 1, color: "white" }}>
            <IoMdSend />
          </IconButton>
        </div>
      </Box>
